...
- 서비스 생성: `POST /api/lc/admin/services`
- 서비스 수정: `POST /api/lc/admin/services/:id/update`
- 서비스 삭제: `POST /api/lc/admin/services/:id/delete`
- 활성/비활성 전환: `POST /api/lc/admin/services/:id/toggle`
