...
- 서비스 생성: `POST /api/services/admin`
- 서비스 수정: `POST /api/services/admin/:id/update`
- 서비스 삭제: `POST /api/services/admin/:id/delete`
- 활성/비활성 전환: `POST /api/services/admin/:id/toggle`
