...
const styles = StyleSheet.create({
  ...
  pickerGrid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 20, paddingTop: 4, paddingBottom: 8 },
  ...
  chipPanel: { borderTopWidth: 1, marginTop: 6, paddingTop: 14, paddingBottom: 4, paddingHorizontal: 20 },
