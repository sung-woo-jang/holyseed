...
const rows: SeedRow[] = [
  {
    workDate: '2026-06-09',
    title: '송도 / 학익',
    address: '송도동 117-37 골프장 / 학익동 풍림아이원 123동 2203호',
    jobs: ['도배', '필름'],
    payStatus: PayStatus.RECEIVED,
  ...
  },
  {
    workDate: '2026-06-12',
    title: '부천 / 학익',
    address: '부천로 90번길 55-5 / 학익동 풍림아이원 123동 2203호',
    jobs: ['철거', '필름'],
    payStatus: PayStatus.RECEIVED,
    workHours: '09:00~23:59',
    amount: 255125,
    memo: '노션 원본 종료시각 24:00(자정) — 앱 형식 제약으로 23:59 표기',
  },
  {
    workDate: '2026-06-13',
    title: '휴무',
  ...
  },
  {
    workDate: '2026-06-16',
    title: '송도',
    address: '송도동 117-37 골프장',
    jobs: ['퍼티'],
    payStatus: PayStatus.RECEIVED,
    workHours: '07:30~19:00',
    amount: 165750,
    memo: null,
  },
  {
...
async function main() {
  ...
  for (const row of rows) {
    ...
    await worklogRepo
      .createQueryBuilder()
      .delete()
      .where('work_date = :workDate', { workDate: row.workDate })
      .execute();
