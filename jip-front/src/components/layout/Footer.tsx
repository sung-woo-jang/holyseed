    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div>
            <Link to="/" className="brand" style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
          ...
          <div>
            <h5>안내</h5>
            <ul>
              <li><Link to="/cases">시공사례</Link></li>
              <li><Link to="/about">시공자 소개</Link></li>
              <li><Link to="/bookings">예약 확인</Link></li>
            </ul>
          </div>
        </div>
