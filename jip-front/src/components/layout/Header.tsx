...
export default function Header() {
  ...
  if (isAdminRoute) {
    return (
      <header className={`topbar admin shadow`}>
        <div className="topbar-inner container">
          <Link to="/admin" className="brand">
            <div className="brand-mark" style={{ background: 'var(--ink)' }}>
              집
            </div>
            <span>
              집수리 <span style={{ color: 'var(--orange)', fontSize: 12, marginLeft: 6, fontWeight: 700 }}>ADMIN</span>
            </span>
          </Link>
          <nav className="nav">
