...
const PHILOSOPHIES = [
  {
    icon: '🔧',
    title: '처음부터 끝까지 직접',
    desc: '외주 없이 혼자 다 합니다. 그래서 책임도 혼자 집니다. 작업하는 동안 중간에 사람이 바뀌지 않아요.',
  },
  {
    icon: '💬',
    title: '견적은 솔직하게',
    desc: '불필요한 추가비용 없이, 처음 안내한 금액으로 진행합니다. 현장에서 바뀌는 일은 꼭 미리 말씀드려요.',
  },
  {
    icon: '🕐',
    title: '약속 시간은 지킵니다',
    desc: '예약 시간 30분 전에 연락드리고, 늦을 땐 미리 알립니다. 시간은 서로 존중하는 것이라 생각해요.',
  },
]
        ...
        <div className="about-cta">
          <div>
            ...
            <div className="hero-meta mt-32">
              <div className="stat">
                <div className="num">{TECH_INFO.years}년</div>
                <div className="lbl">경력</div>
              </div>
              <div className="stat">
                <div className="num">{TECH_INFO.jobs}+</div>
                <div className="lbl">시공 건수</div>
              </div>
              <div className="stat">
                <div className="num">★ {TECH_INFO.rating}</div>
