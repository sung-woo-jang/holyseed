...
import type { AccountDto, TossOrderDto } from '@/lib/types'
import { api, krw, kst, n, usd } from '@/lib/types'
          ...
          {rows.map((o) => {
            ...
            return (
              <tr key={o.orderId}>
                ...
                <td className="l">
                  {link ? (
                    <Link to={`/cycles/${link.cycleNo}/trades/${link.seq}`} style={{ fontSize: 12 }}>
