...
export async function createServices() {
  ...
  const servicesData = [
    {
      title: '인테리어 필름',
      description: '싱크대, 가구, 문틀 등에 고급 인테리어 필름을 시공합니다. 새 집처럼 깔끔하게 변신시켜 드립니다.',
      iconId: homeIcon.id,
      iconBgColor: '#E3F2FD',
      iconColor: '#424242',
      duration: '하루 종일',
    ...
    {
      title: '유리 청소',
      description: '아파트, 상가, 오피스텔 등 고층 유리창 전문 청소 서비스입니다. 깨끗하고 안전하게 시공합니다.',
    ...
    {
      title: '방충망 설치',
      description: '튼튼한 방충망 교체 및 신규 설치 서비스입니다. 맞춤 제작하여 깔끔하게 시공합니다.',
      iconId: gridIcon.id,
      iconBgColor: '#FFF3E0',
      iconColor: '#424242',
      duration: '30분-1시간',
