...
```typescript
interface UploadReservationPhotosResponse {
  photos: Array<{
    filename: string;   // 원본 파일명 (WebP 확장자)
    path: string;       // NCP Object Storage S3 키
    url: string;        // 공개 URL
  }>;
}
```
...
// Example
{
  "photos": [
    {
      "filename": "photo_1735612345678.webp",
      "path": "reservations/photo_1735612345678.webp",
      "url": "https://kr.object.ncloudstorage.com/living-craft/reservations/photo_1735612345678.webp"
    }
  ]
}
```
