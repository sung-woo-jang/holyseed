...
import { Media, WeddingVenue, AccountInfo, mediaResizedUrl } from '@/types'
import NetflixIntro from '@/components/intro/NetflixIntro'
import NetflixNav from '@/components/navigation/NetflixNav'
import NetflixRow from '@/components/gallery/NetflixRow'
import VenueModal from '@/components/modals/VenueModal'
import AttendanceModal from '@/components/modals/AttendanceModal'
import KakaoMapScript from '@/components/invitation/KakaoMapScript'
import styles from './InvitationPage.module.css'

const KakaoMap = lazy(() => import('@/components/invitation/KakaoMap'))
